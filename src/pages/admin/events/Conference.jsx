...
import { conferenceFormVariant } from '../../../utils/profileFormConfigs';
...
const Conference = () => {
  ...
  // Column definitions matching your Conference screenshot
  const columns = [
    { 
      title: '#', 
      dataIndex: 'id', 
  ...
  const ConferenceData = [
    ...
    { id: '06', name: 'Web Dev Conference', organizer: 'CodeCrafters United', date: '25/09/2026', mode: 'Offline', regType: 'Paid', fees: '₹750', applied: '150', status: 'active' },
  ...
  return (
    <div className="bg-[#F9FAFB] min-h-screen">
      ...
      <DynamicTable
        ...
        rowKey="id"
        onRowClick={() => navigate('/admin/conference-profile')}
        // Search Config
        showSearch={true}
        ...
        onAdd={() =>
          navigate('/admin/add-form', {
            state: { formType: 'conference', formVariant: conferenceFormVariant },
          })
        } 
