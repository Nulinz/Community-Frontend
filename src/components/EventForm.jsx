...
const eventFormConfig = [
  ...
  // },
  {
    ...
    fields: [
      ...
      { showWhen: { field: "prizesAvailable", value: "Yes" }, name: "firstPrize", label: "1st Prize", type: "text", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "certificateContentBody", label: "Certificate Body Text", type: "textarea", span: 2, placeholder: "e.g. Has successfully participated in the event...", required: false },
    ],
  },
];
...
const EventForm = () => {
  ...
  const handleSubmit = async (formData, payload) => {
    try {
      ...
      // Final boundary validation check prior to submission
